	...
	<view class="uni-calendar" @touchmove.stop.prevent="clean">
		...
		<view v-if="insert || show" class="uni-calendar__content" :class="{'uni-calendar--fixed':!insert,'uni-calendar--ani-show':aniMaskShow}">
			<!-- <view v-if="!insert" class="uni-calendar__header uni-calendar--fixed-top">
				...
				<view class="uni-calendar__header-btn-box" @click="close">
					<text class="uni-calendar__header-text uni-calendar--fixed-width">X</text>
				</view>
			</view> -->
			<view class="uni-calendar__header">
				...
				<icon class="iconfont iconguanbi uni-calendar__backtoday" @click="close" />
			</view>
			<view class="uni-calendar__box">
				...
				<view class="uni-calendar__weeks" v-for="(item,weekIndex) in weeks" :key="weekIndex">
					<view class="uni-calendar__weeks-item" v-for="(weeks,weeksIndex) in item" :key="weeksIndex">
						<uni-calendar-item :weeks="weeks" :weeksIndex="weeksIndex" :calendar="calendar" :selected="selected" :lunar="lunar" @change="choiceDate"></uni-calendar-item>
					</view>
				</view>
			</view>
		</view>
